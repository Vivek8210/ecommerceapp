...
const Footer = () => {
  return (
      ...
      <Container as={Stack} maxW={'6xl'} py={10}>
        <SimpleGrid
          templateColumns={{ base:'1fr 1fr 1fr', lg: '1fr 1fr 1fr 1fr 1fr 1fr 1fr' , md: '1fr 1fr 1fr '}}
          spacing={10}>
          ...
          <Stack align={'flex-start'}>
            ...
            <Link href={'#'}> <img src="https://www.bing.com/th?id=OIP.6-Etwy2306AInODxxbDK6gHaHY&w=250&h=249&c=8&rs=1&qlt=90&o=6&pid=3.1&rm=2" alt=""  style={{width:"25%"}} /> </Link>
            <Link href={'#'}> <img src="https://www.bing.com/th?id=OIP.o06snWh5G4LQ1fJbNlarpAHaGB&w=277&h=225&c=8&rs=1&qlt=90&o=6&pid=3.1&rm=2" alt=""  style={{width:"25%"}} /> </Link>
            <Link href={'#'}> <img src="https://th.bing.com/th/id/OIP.Qsl7ZlqntEmmCLXEnfxLOgHaHa?w=197&h=197&c=7&r=0&o=5&pid=1.7" alt=""  style={{width:"25%"}} /> </Link>
            <Link href={'#'}> <img src="https://th.bing.com/th/id/OIP.HIGoNhL73ViiiLBYrQSEHgHaHa?w=170&h=180&c=7&r=0&o=5&pid=1.7" alt=""  style={{width:"25%"}} /> </Link>
      ...
      <Box py={10}>
        <Flex
          ...
          {/* <Logo /> */}
          <img src="https://codegama.com/assets/img/codegama-logo.png" alt="" style={{width:"160px",height:"90px"}} />
        </Flex>
        <Text pt={6} fontSize={'sm'} textAlign={'center'}>
        <b>Copyright ©2022. All rights reserved Design & Developed By</b> vivek kumar
        </Text>
      </Box>
    </Box>
